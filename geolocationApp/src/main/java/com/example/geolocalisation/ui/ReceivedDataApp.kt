...
package com.example.geolocalisation.ui
...
fun ReceivedDataApp() {
    ...
    Scaffold(
        ...
        topBar = { ReceivedDataAppTopBar(scrollBehavior = scrollBehavior) }
    ) {
        Surface(
...
@Composable
fun ReceivedDataAppTopBar(scrollBehavior: TopAppBarScrollBehavior, modifier: Modifier = Modifier) {
